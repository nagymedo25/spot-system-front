  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute bottom-5 w-full text-center z-20"
      >
        ...
        <Link
          to="/report-view"
          state={{ teacher }}
          className="inline-block bg-spot-cyan text-black px-6 py-2 rounded-full font-semibold transition-all hover:bg-white hover:shadow-cyan-glow"
        >
          عرض التقارير
        </Link>
      </motion.div>
